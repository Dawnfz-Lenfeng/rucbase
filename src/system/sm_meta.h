...
struct ColMeta {
    ...
    bool operator==(const ColMeta &other) const { return tab_name == other.tab_name && name == other.name; }
};
...
struct IndexMeta {
    ...
    IndexMeta() {}
    IndexMeta(const std::string &tab_name, const std::vector<ColMeta> &cols, int col_tot_len, size_t col_num)
        : tab_name(tab_name), col_tot_len(col_tot_len), col_num(col_num), cols(cols) {}
    ...
    bool operator==(const IndexMeta &other) const {
        return tab_name == other.tab_name && col_tot_len == other.col_tot_len && col_num == other.col_num &&
               cols == other.cols;
    }
...
class DbMeta {
   ...
   public:
    DbMeta() {}
    DbMeta(const std::string &name) : name_(name) {}
